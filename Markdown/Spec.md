...
Если после закрывающего подчерка сразу следует открывающий, считаются только крайние подчерки, внутренние остаются подчерками:
_поле__поле_ == "<em>поле__поле</em>"
__поле____поле__ == "<strong>поле____поле</strong>"
